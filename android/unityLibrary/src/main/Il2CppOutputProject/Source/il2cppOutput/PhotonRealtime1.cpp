...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void U3CU3CStartCoroutineAndDestroyU3Eg__RoutineU7C0U3Ed__ctor_m85FC9912D3AA7FEFB73B79ED7F846B9426005D8C (U3CU3CStartCoroutineAndDestroyU3Eg__RoutineU7C0U3Ed_tE97032330AFD4F178D4F60AD4613C6E610DED26B* __this, int32_t ___U3CU3E1__state0, const RuntimeMethod* method) ;
...
IL_024c:
	{
		...
		int32_t L_76;
		L_76 = Enumerable_Min_m08CFCF12550397A30F094F24E2F68AD21E98EC9F(L_75, NULL);
		V_2 = L_76;
		// int worstRtt = this.rttResults.Max();
		RegionPinger_t953E42BC59C48354AE8AAB91E932BB79CB49930B* L_77 = V_1;
		NullCheck(L_77);
		List_1_t05915E9237850A58106982B7FE4BC5DA4E872E73* L_78 = L_77->___rttResults_8;
		int32_t L_79;
		L_79 = Enumerable_Max_m30DE6D3273F1E770CC99EC43653F8F4BA4A94760(L_78, NULL);
		V_3 = L_79;
		...
		NullCheck(L_83);
		Region_tD981338A8FBC28C39100FF9111854EC8ABE8619A* L_84 = L_83->___region_9;
		int32_t L_85 = V_4;
		...
		NullCheck(L_87);
		Action_1_tE4E9B9131F210B39DCBA3BF8F226941D0D3EAF73* L_88 = L_87->___onDoneCall_6;
		RegionPinger_t953E42BC59C48354AE8AAB91E932BB79CB49930B* L_89 = V_1;
		NullCheck(L_89);
		Region_tD981338A8FBC28C39100FF9111854EC8ABE8619A* L_90 = L_89->___region_9;
		NullCheck(L_88);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR MonoBehaviourEmpty_t8BBCD2C733FF1AA5B134D7290654C2869AA7C2E9* MonoBehaviourEmpty_BuildInstance_m3DD7B4DCC4AC495104FF954BE90167264A04E089 (String_t* ___id0, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MonoBehaviourEmpty_StartCoroutineAndDestroy_mA18ABB16FC70936ED743F728EAD15F36B9B25815 (MonoBehaviourEmpty_t8BBCD2C733FF1AA5B134D7290654C2869AA7C2E9* __this, RuntimeObject* ___coroutine0, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Room_set_MaxPlayers_mA074188537B89C4CD87C9986AD7B8D8065C1D161 (Room_t9CCA5C06B8CE2E5E1EE24AD17360F218C4E36373* __this, int32_t ___value0, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	uint8_t V_0 = 0x0;
	{
		...
		int32_t L_1 = ((RoomInfo_t4C5919F4F2B1DCDEA81D1522AFD5008072A7D29D*)__this)->___maxPlayers_2;
		if ((((int32_t)L_0) == ((int32_t)L_1)))
		{
			goto IL_003f;
		}
	...
	}
	{
		...
		NullCheck(L_6);
		Hashtable_Add_mC74BB7662FF6F194D0E067509BD2AC3329C2EE41(L_6, (uint8_t)((int32_t)255), L_9, NULL);
		NullCheck(L_4);
		bool L_10;
		L_10 = LoadBalancingClient_OpSetPropertiesOfRoom_mDB4F00727530FF42223D2277EA968383B82B2115(L_4, L_6, (Hashtable_tD626399B3ADFD501225241D7366103F35472542A*)NULL, (WebFlags_tFD3605BF6E5F1A42F1D0D6F0DA9A8B32CF7B27CA*)NULL, NULL);
	}
...
IL_0069:
	{
		...
		Hashtable_tD626399B3ADFD501225241D7366103F35472542A* L_16 = ___propertiesToCache0;
		NullCheck(L_16);
		bool L_17;
		L_17 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_16, (uint8_t)((int32_t)253), NULL);
		if (!L_17)
		{
			goto IL_008c;
		}
	}
	{
		...
		Hashtable_tD626399B3ADFD501225241D7366103F35472542A* L_18 = ___propertiesToCache0;
		NullCheck(L_18);
		RuntimeObject* L_19;
		L_19 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_18, (uint8_t)((int32_t)253), NULL);
		__this->___isOpen_6 = ((*(bool*)((bool*)(bool*)UnBox(L_19, Boolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_il2cpp_TypeInfo_var))));
	}

IL_008c:
	{
		// if (propertiesToCache.ContainsKey(GamePropertyKey.IsVisible))
		Hashtable_tD626399B3ADFD501225241D7366103F35472542A* L_20 = ___propertiesToCache0;
		NullCheck(L_20);
		bool L_21;
		L_21 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_20, (uint8_t)((int32_t)254), NULL);
		if (!L_21)
		{
			goto IL_00af;
		}
	}
	{
		...
		__this->___isVisible_7 = ((*(bool*)((bool*)(bool*)UnBox(L_23, Boolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_il2cpp_TypeInfo_var))));
	}
...
IL_00af:
	{
		...
		NullCheck(L_24);
		bool L_25;
		L_25 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_24, (uint8_t)((int32_t)252), NULL);
		if (!L_25)
		{
			goto IL_00d2;
		}
	}
	{
		...
		Hashtable_tD626399B3ADFD501225241D7366103F35472542A* L_26 = ___propertiesToCache0;
		NullCheck(L_26);
		RuntimeObject* L_27;
		L_27 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_26, (uint8_t)((int32_t)252), NULL);
		il2cpp_codegen_runtime_class_init_inline(Convert_t7097FF336D592F7C06D88A98349A44646F91EFFC_il2cpp_TypeInfo_var);
		int32_t L_28;
		L_28 = Convert_ToInt32_m6CCBC0A6ED81DAF7191F4C4F55CA038AF9B1E042(L_27, NULL);
		RoomInfo_set_PlayerCount_m60E2655747392B753F507AF760FD5F1CE2C25B02_inline(__this, L_28, NULL);
	}
...
IL_00d2:
	{
		...
		NullCheck(L_29);
		bool L_30;
		L_30 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_29, (uint8_t)((int32_t)249), NULL);
		if (!L_30)
		{
			goto IL_00f5;
		}
	}
	{
		...
		NullCheck(L_31);
		RuntimeObject* L_32;
		L_32 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_31, (uint8_t)((int32_t)249), NULL);
		__this->___autoCleanUp_8 = ((*(bool*)((bool*)(bool*)UnBox(L_32, Boolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_il2cpp_TypeInfo_var))));
	}
...
IL_00f5:
	{
		...
		NullCheck(L_33);
		bool L_34;
		L_34 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_33, (uint8_t)((int32_t)248), NULL);
		if (!L_34)
		{
			goto IL_0118;
		}
	}
	{
		...
		NullCheck(L_35);
		RuntimeObject* L_36;
		L_36 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_35, (uint8_t)((int32_t)248), NULL);
		__this->___masterClientId_10 = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_36, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var))));
	}
...
IL_0118:
	{
		...
		NullCheck(L_37);
		bool L_38;
		L_38 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_37, (uint8_t)((int32_t)250), NULL);
		if (!L_38)
		{
			goto IL_013b;
		}
	}
	{
		...
		NullCheck(L_39);
		RuntimeObject* L_40;
		L_40 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_39, (uint8_t)((int32_t)250), NULL);
		__this->___propertiesListedInLobby_11 = ((StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248*)IsInst((RuntimeObject*)L_40, StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248_il2cpp_TypeInfo_var));
		Il2CppCodeGenWriteBarrier((void**)(&__this->___propertiesListedInLobby_11), (void*)((StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248*)IsInst((RuntimeObject*)L_40, StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248_il2cpp_TypeInfo_var)));
	}
...
IL_013b:
	{
		...
		NullCheck(L_41);
		bool L_42;
		L_42 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_41, (uint8_t)((int32_t)247), NULL);
		if (!L_42)
		{
			goto IL_015e;
		}
	}
	{
		...
		NullCheck(L_43);
		RuntimeObject* L_44;
		L_44 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_43, (uint8_t)((int32_t)247), NULL);
		__this->___expectedUsers_5 = ((StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248*)Castclass((RuntimeObject*)L_44, StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248_il2cpp_TypeInfo_var));
		Il2CppCodeGenWriteBarrier((void**)(&__this->___expectedUsers_5), (void*)((StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248*)Castclass((RuntimeObject*)L_44, StringU5BU5D_t7674CD946EC0CE7B3AE0BE70E6EE85F2ECD9F248_il2cpp_TypeInfo_var)));
	}
...
IL_015e:
	{
		...
		NullCheck(L_45);
		bool L_46;
		L_46 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_45, (uint8_t)((int32_t)245), NULL);
		if (!L_46)
		{
			goto IL_0181;
		}
	}
	{
		...
		NullCheck(L_47);
		RuntimeObject* L_48;
		L_48 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_47, (uint8_t)((int32_t)245), NULL);
		__this->___emptyRoomTtl_3 = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_48, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var))));
	}
...
IL_0181:
	{
		...
		NullCheck(L_49);
		bool L_50;
		L_50 = Hashtable_ContainsKey_m3D587133716FB10E52C313BA3C8FC186363ED2F1(L_49, (uint8_t)((int32_t)246), NULL);
		if (!L_50)
		{
			goto IL_01a4;
		}
	}
	{
		...
		Hashtable_tD626399B3ADFD501225241D7366103F35472542A* L_51 = ___propertiesToCache0;
		NullCheck(L_51);
		RuntimeObject* L_52;
		L_52 = Hashtable_get_Item_mE4741BBE2CD6294D3AC71811668524D262387B2A(L_51, (uint8_t)((int32_t)246), NULL);
		__this->___playerTtl_4 = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_52, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var))));
	}
...
IL_01a4:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Extensions_t7A83CB812F88E252E8AEFBDB2325836C473E0BA7_il2cpp_TypeInfo_var);
		Extensions_MergeStringKeys_m94C359A20CC762B42BA8FE066215F05C4B006934(L_53, L_54, NULL);
		// this.customProperties.StripKeysWithNullValues();
		Hashtable_tD626399B3ADFD501225241D7366103F35472542A* L_55 = __this->___customProperties_1;
		Extensions_StripKeysWithNullValues_m21D97C2232289C808C8926341933B9D0F83A7F73(L_55, NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SupportLogger_LogBasics_mCA2B0EB1C33461698C1F0DC865A3189394B46CFB (SupportLogger_t853FFDC016DE6BEBBC2DBBF6EA668299E4C524DD* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_9);
		List_1_Add_mF10DB1D3CBB0B14215F0E4F8AB4934A1955E5351_inline(L_9, _stringLiteralD9E5192EBC7274833C57CDADEBF297584EA1559B, List_1_Add_mF10DB1D3CBB0B14215F0E4F8AB4934A1955E5351_RuntimeMethod_var);
